...
class Login:
   ...
   def loginform(self):
      ...
      label1=Label(frame_input,text="User Login",font=('impact',32,'bold'),fg="black",bg='white')
      ...
      btn2=Button(frame_input,text="Login",command=self.enter,cursor="hand2",
