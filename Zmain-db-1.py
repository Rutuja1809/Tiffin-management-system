...
img_menu1=tk.PhotoImage(file=path_image+"food-item-11.png")
img_menu2=tk.PhotoImage(file=path_image+"food-item-21.png")
img_menu3=tk.PhotoImage(file=path_image+"food-item-31.png")
img_menu4=tk.PhotoImage(file=path_image+"food-item-41.png")
img_menu5=tk.PhotoImage(file=path_image+"food-item-51.png")
img_menu6=tk.PhotoImage(file=path_image+"food-item-61.png")
img_menu7=tk.PhotoImage(file=path_image+"food-item-71.png")
img_menu8=tk.PhotoImage(file=path_image+"food-item-81.png")
