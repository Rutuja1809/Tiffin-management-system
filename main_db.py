...
label2=Label(frame_m_right,text="Name",font=("Goudy old style",20,"bold"),fg='orangered',bg='white')
label2.grid(row=4,column=0)
e1=tk.StringVar() 
email_txt=Entry(frame_m_right,font=("times new roman",15,"bold"),bg='lightgray',textvariable=e1)
email_txt.grid(row=5,column=0)
...
def my_reset():
    ...
    query="insert INTO  plus2_bill (Total,tax,`bill_date`,cust_e) \
                  VALUES (%s,%s,%s,%s)"
    data=[total,tax,dt,e2]
...
#path_image="C:\Users\\Saurabh\\OneDrive\\Desktop\\Rutuja\\images"
font1=('Times',14,'normal')
font2=('Times',32,'bold')
pdx,pdy=1,5
#img_top = tk.PhotoImage(file = "images/img1.jpg")
#bg=tk.PhotoImage(file="images/img2.jpg")
...
b2=tk.Button(frame_bottom,text='CONFIRM(BILL)',command=my_reset)
